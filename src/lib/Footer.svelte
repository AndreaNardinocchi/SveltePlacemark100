<footer class="footer has-background-dark mt-6">
  <div class="columns content is-medium has-text-white px-6">
    <section class="column is-6 pl-6 ml-6">
      <h4 class="has-text-white">Address</h4>
      <p>
        2 Church Gate,<br />
        Blackrock<br />
        Cork<br />
    ...
    <section class="column is-6 pl-6 ml-6">
      <h4 class="has-text-white">Projects</h4>
      <!-- https://www.w3.org/WAI/WCAG21/Techniques/aria/ARIA8 'aria-label" how to use it -->
      <a
        href="https://github.com/AndreaNardinocchi/placemark"
        target="_blank"
...
<div class="underfooter column is-full has-background-grey-dark">
  <article class="content has-text-white has-text-centered">
    <a href="/" aria-label="Opens on the main page">
      <svg
        style="font-size: 12px; color: white; width: 24px; height: 24px; padding-top: 8px; padding-right: 8px;"
