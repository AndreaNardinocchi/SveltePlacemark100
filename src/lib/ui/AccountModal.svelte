<script lang="ts">
  ...
  let {
    ...
    userLat = $bindable("40.7128"),
    userLong = $bindable("-74.006"),
    addressCode = $bindable("12345"),
    phoneNumber = $bindable("1234567890"),
    email = $bindable("john.doe@example.com"),
  ...
  function openModal() {
    isModalOpen = true;
    console.log("Modal is now open:", isModalOpen); // Debugging log
  }

  function closeModal() {
    isModalOpen = false;
    console.log("Modal is now closed:", isModalOpen); // Debugging log
  }
</script>

<!-- svelte-ignore event_directive_deprecated -->
<button class="button is-light m-2" on:click={openModal}> Update account </button>
{#if isModalOpen}
      ...
      <div class="box">
        ...
        <section class="column is-12 pt-2">
            ...
            <div class="field-body">
              ...
              <div class="field">
                <label class="label">
                  Street
                  <p class="control is-expanded has-icons-left">
                    <input class="input" type="text" name="street" bind:value={street} />
                    <span class="icon is-small is-left">
            ...
            <div class="field-body">
              <div class="field">
                <label class="label">
                  Address Code
                  <p class="control is-expanded has-icons-left">
                    <input class="input" type="text" name="addressCode" bind:value={addressCode} />
                    <span class="icon is-small is-left">
          ...
          <div class="field is-grouped">
            <button class="button is-light">Update User</button>
          </div>
          <!-- </form> -->
        </section>
      </div>
